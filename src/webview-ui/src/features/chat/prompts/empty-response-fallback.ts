export const EMPTY_RESPONSE_FALLBACK = `⚠️ WARNING: Your previous response was invalid — it contained only an empty <thinking></thinking> block with no meaningful content, tool calls, or questions.

This is a critical error. You MUST NOT respond with only an empty thinking block.

If you have nothing to say or need clarification, you MUST ask a question using the <question> tag format.
