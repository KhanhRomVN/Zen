...
const PERMISSION_MODES: {
  ...
  color: string;
  labelKey: "settings.fullAccessLabel" | "settings.approvalLabel" | "settings.readOnlyLabel";
  descKey: "settings.fullAccessDesc" | "settings.approvalDesc" | "settings.readOnlyDesc";
}[] = [
  {
    id: "fullAccess",
    icon: <Zap size={14} />,
    color: "var(--vscode-editorBracketHighlight-foreground3, #f59e0b)",
    labelKey: "settings.fullAccessLabel",
    descKey: "settings.fullAccessDesc",
  },
  {
    id: "approval",
    icon: <ShieldCheck size={14} />,
    color: "var(--vscode-symbolIcon-interfaceForeground, #3b82f6)",
    labelKey: "settings.approvalLabel",
    descKey: "settings.approvalDesc",
  },
  {
    id: "readOnly",
    icon: <Eye size={14} />,
    color: "var(--vscode-symbolIcon-classForeground, #8b5cf6)",
    labelKey: "settings.readOnlyLabel",
    descKey: "settings.readOnlyDesc",
  },
];
            ...
            return (
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "2px", flex: 1 }}>
                  ...
                  <span
                    style={{ fontSize: "10.5px", opacity: isSelected ? 0.9 : 0.6, lineHeight: "1.3" }}
                  >
                    {t(mode.descKey)}
                  </span>
                </div>
