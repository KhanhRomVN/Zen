export const en = {
  settings: {
    ...
    fullAccessDesc: "All tools execute automatically without prompting.",
    approvalLabel: "Approval",
    approvalDesc: "Read tools execute automatically; all other tools require approval.",
    readOnlyLabel: "Read Only",
    readOnlyDesc: "Read tools execute automatically; writes and commands are blocked.",
  },
  chat: {
