...
thì gặp lỗi "MISSING_REQUIRED_PARAM: Missing required parameter(s) in <replace_in_file>: new_content. Please ensure all required parameters are present.". 
...
thì lại ko lỗi. cần tìm ra nguyên nhân lỗi